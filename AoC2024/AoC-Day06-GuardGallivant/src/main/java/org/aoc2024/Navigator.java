...
//    public Navigator updateNavForDot(Navigator inputNav) {
//        return new Navigator(inputNav.getMovement(), inputNav.getNextStep(), inputNav.updateNextStep(inputNav.getCurrentStep(), inputNav.getMovement()));
//    }
}
